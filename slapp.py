...
st.set_page_config(page_title=TITEL, layout="wide", page_icon=":pushpin:")
...
chknan = col2.checkbox(
    label="incl. leerer Spalten",
    value=True,
    key="chk_nan",
...
chkbool = col2.radio(
    label="exportiere Feldtyp _'Checkbox'_ als:",
    options=['"Wahr"', "1", "Ja"],
    key="chk_bool",
...
if len(dateien) == 2:
    ...
    st.session_state["df_exp"] = update_export_df(
        st.session_state["df_main"], chknan, chkbool
    )
